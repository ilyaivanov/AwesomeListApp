...
describe('Parsing frontend repo', () => {
  let sections:Section[];
  beforeEach(() => {
    sections = parseIntoSections(parseMd(md), root.id);
  })

  it('should result in root with', function () {

  });
});


const md = `# Frontend Development [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome)
